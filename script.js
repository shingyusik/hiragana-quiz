...
const VOCAB_GROUP_CONFIG = {
  ...
  color: {
    label: "색깔",
    description: "기본 색 이름과 색을 설명할 때 자주 쓰는 표현입니다."
  },
  body: {
    label: "신체",
...
const VOCAB_ITEMS = [
  ...
  },
  {
    ...
    reading: "aka",
    meaning: "빨강, 빨간색",
    accepted: ["빨강", "빨간색", "빨간 색"],
    example: "あかい くるまが あります。",
    note: "색 이름의 기본형입니다. 형용사 `あかい`와 같이 연결해서 익히면 좋습니다.",
    kana: ["あ", "か"],
    group: "color",
    tags: ["기본 색", "따뜻한 색"]
  },
  {
    ...
    reading: "ao",
    meaning: "파랑, 파란색",
    accepted: ["파랑", "파란색", "파란 색", "파랑색"],
    example: "そらは あおいです。",
    note: "하늘과 바다 이미지를 같이 떠올리면 기억이 쉽습니다.",
    kana: ["あ", "お"],
    group: "color",
    tags: ["기본 색", "차가운 색"]
  },
  {
    ...
    reading: "kiiro",
    meaning: "노랑, 노란색",
    accepted: ["노랑", "노란색", "노란 색", "노랑색"],
    example: "きいろい はなが さいています。",
    note: "`い`가 길게 이어지는 발음을 같이 확인하면 덜 헷갈립니다.",
    kana: ["き", "い", "ろ"],
    group: "color",
    tags: ["기본 색", "밝은 색"]
  },
  {
    ...
    meaning: "초록, 초록색",
    accepted: ["초록", "초록색", "녹색"],
    example: "みどりの きが おおいです。",
    note: "자연 단어와 같이 반복하면 색과 장면이 함께 기억됩니다.",
    kana: ["み", "ど", "り"],
    group: "color",
    tags: ["기본 색", "자연"]
  },
  {
    ...
    reading: "shiro",
    meaning: "하양, 흰색",
    accepted: ["하양", "흰색", "하얀색", "백색"],
    example: "しろい ねこが います。",
    note: "`し` 발음이 들어가므로 로마자와 한글 읽기를 함께 확인하세요.",
    kana: ["し", "ろ"],
    group: "color",
    tags: ["기본 색", "밝은 색"]
  },
  {
    ...
    reading: "kuro",
    meaning: "검정, 검은색",
    accepted: ["검정", "검은색", "검정색", "흑색"],
    example: "くろい かさを つかいます。",
    note: "`しろ`와 짝으로 외우면 대비가 분명해서 오래 갑니다.",
    kana: ["く", "ろ"],
    group: "color",
    tags: ["기본 색", "어두운 색"]
  },
  {
    ...
    meaning: "보라, 보라색",
    accepted: ["보라", "보라색", "자주색"],
    example: "むらさきの ふくが すきです。",
    note: "길이가 조금 있는 단어라 끊어 읽지 말고 한 번에 익히는 편이 좋습니다.",
    kana: ["む", "ら", "さ", "き"],
    group: "color",
    tags: ["응용 색", "차가운 색"]
  },
  {
    ...
    meaning: "분홍, 분홍색",
    accepted: ["분홍", "분홍색", "핑크"],
    example: "ピンクの ペンを かいました。",
    note: "카타카나 색 이름이라 글자 모양까지 같이 익히면 좋습니다.",
    kana: ["ピ", "ン", "ク"],
    group: "color",
    tags: ["응용 색", "카타카나"]
  },
  {
    ...
    reading: "orenji",
    meaning: "주황, 주황색",
    accepted: ["주황", "주황색", "오렌지색", "오렌지"],
    example: "オレンジの かばんです。",
    note: "과일 `オレンジ`와 색 이름이 같다는 점을 같이 기억하면 편합니다.",
    kana: ["オ", "レ", "ン", "ジ"],
    group: "color",
    tags: ["응용 색", "카타카나"]
  },
  {
    ...
    meaning: "갈색",
    accepted: ["갈색", "브라운", "갈색빛"],
    example: "ちゃいろの いぬが います。",
    note: "`ちゃ` 요음이 들어가므로 소리와 글자를 함께 확인하세요.",
    kana: ["ちゃ", "い", "ろ"],
    group: "color",
    tags: ["응용 색", "요음"]
  },
...
function getGuideItems() {
  ...
  if (state.category === "vocab") {
    ...
    if (state.vocabGroup === "color") {
      return state.mode === "learn"
        ? [
            "색깔 단어는 사물과 같이 묶어 `あかい くるま`, `しろい ねこ`처럼 장면째 외우는 편이 빠릅니다.",
            "`あか / あお / しろ / くろ`처럼 자주 쓰는 기본 색부터 먼저 고정하고 응용 색은 뒤에 붙이세요.",
            "카타카나 색 이름과 히라가나 색 이름이 섞여 있으니 표기 차이도 같이 확인하세요."
          ]
        : [
            "색깔 퀴즈는 뜻만 맞히지 말고 어떤 사물과 자주 붙는지도 함께 떠올리세요.",
            "`しろ`와 `くろ`, `あか`와 `あお`처럼 대비되는 색을 세트로 복습하면 헷갈림이 줄어듭니다.",
            "정답 확인 뒤 `...の ...`나 `...いです` 형태로 한 번 더 말해보면 실전 전환이 빨라집니다."
          ];
    }
